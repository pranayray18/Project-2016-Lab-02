...
mysqli_query($con,"UPDATE userlist SET status='Active', password='$password', expiry_date='$exp_date' WHERE username = '$username'");
mysqli_close($con);

//Mail To The User Confirming The Creation
$to = "$email";
$subject = "Campus Karma : Linux User Activation Request";
...
Thanks for choosing Campus Karma. We are happy to see you back.<br><br>This is in reference to your account activation request for linux ssh access on our lab portal, your account has been activated successfully.<br><br>Please find below your new login details:<br><br><b>Host: campuskarma.cloudapp.net<br>Port: 22<br>User name: $username<br>Password: $password <br>Account Expiry: $exp_date</b><br><br>Please Note, Your account is active for 90 days, prior to that you can extend the usage period for which you have to login to the portal and request for the extension. It is also requested that you login to your account and change your password. For more details on how to login <a href='".elgg_get_site_url()."linux/instruction'>click here</a>.
...
//system_message(elgg_echo("User has been activated successfully. Check your mail for login details."));
echo "User has been activated successfully. Check your mail for login details.";
} else {
	$ssh->exec("sudo userdel " . $username);
	$ssh->exec("sudo rm -rf /home/".$username);
